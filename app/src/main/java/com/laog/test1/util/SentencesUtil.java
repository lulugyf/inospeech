...
/**
 *
 * https://github.com/shuaijia/RichTextView android textview 点击 断句
 * 文本断句
 *
...
public class SentencesUtil
{
    ...
    public static void main(String[] args) throws Exception {
        String content = TextUtil.fileToString("d:/tmp/d/cc.txt");
        List<String> ss = SentencesUtil.toSentenceList(content, false);
        for(String s: ss)
