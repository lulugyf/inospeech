...
public class YTListActivity extends Activity implements View.OnClickListener {
    ...
    private void rxtest() {
            ...
            Observer<String> stringObserver = new Observer<String>() {
                ...
                public void onNext(String s) {
                    Toast.makeText(YTListActivity.this, s, Toast.LENGTH_SHORT).show();
                    Log.d(TAG, "---haha:"+s);
                }
    ...
    private void rxtest1() {
        ...
        mObserver = new Observer<Integer>() {
            @Override
            public void onSubscribe(Disposable d) {
                Toast.makeText(YTListActivity.this, "onSubscribe called", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onNext(Integer integer) {
                Toast.makeText(YTListActivity.this, "onNext called: " + integer, Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onError(Throwable e) {
                Toast.makeText(YTListActivity.this, "onError called", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onComplete() {
                Toast.makeText(YTListActivity.this, "onComplete called", Toast.LENGTH_SHORT).show();
            }
        };
    }
}
